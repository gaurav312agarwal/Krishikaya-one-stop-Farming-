...
export default function EquipmentRegister() {
  ...
  return (
    <div className="fade-in-bg" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      ...
      <form onSubmit={handleRegister} className="main-body" style={{ maxWidth: 400, margin: "0 auto", padding: "4vmin", background: "antiquewhite", borderRadius: 12, boxShadow: "0 2px 8px #0002" }}>
        <h2 className="heading" style={{ position: "static", fontSize: "4vmin", marginBottom: "2vmin" }}>Register</h2>
        ...
        <button type="submit" className="but linkk animated-btn" style={{ width: "100%", fontSize: "3vmin", marginTop: "2vmin" }}>Register</button>
      </form>
    </div>
  );
} 